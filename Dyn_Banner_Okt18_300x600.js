...
(function ($) {
    ...
    $.imagePreloader = function(p) {
        ...
        my.getTmplAttr('BannerBG_300', my.BannerBG_300, url);
        my.getTmplAttr('BannerBG2_300', my.BannerBG2_300, url);
        my.getTmplAttr('BannerBG3_300', my.BannerBG3_300, url);
...
var NFQDA = (function(my) {
    ...
    my.createCss = function(doc) {
        ...
        +'@keyframes fingerani {'
        +'  0% {bottom: 0px;left:200px;opacity: 0;}'
        +'  62% {bottom: 0px;left:200px;opacity: 0;}'
        +'  68% {bottom: 40px;left:150px;opacity: 1;}'
        +'  69% {bottom: 38px;left:150px;opacity: 1;}'
        +'  70% {bottom: 40px;left:150px;opacity: 1;}'
        +'  98% {bottom: 40px;left:150px;opacity: 1;}'
        +'  100% {bottom: 40px;left:150px;opacity: 0;}'
        +'}'

        +'#BannerBG {'
        +'  background-image: url('+ my.BannerBG_300 +');'
        ...
        +'#BannerBG2 {'
        +'  background-image: url('+ my.BannerBG2_300 +');'
        +'  background-color: ' + my.bannerBGColor + ';'
        +'  background-size: cover;'
        +'  width: 100%;'
        +'  height: 100%;'
        ...
        +'#BannerBG3 {'
        +'  background-image: url('+ my.BannerBG3_300 +');'
        +'  background-color: ' + my.bannerBGColor + ';'
        +'  background-repeat: no-repeat;'
        +'  background-size: cover;'
        +'  width: 100%;'
        ...
        +'  5% {margin-left: -90px;opacity: 1;}'
        +'  25%{margin-left: -90px;opacity: 1;}'
        +'  30%{margin-left: -90px;opacity: 0;}'
        +'  100% {margin-left: -90px;opacity: 0;}'
        +'}'
        ...
        +'  30% {bottom: 15px;opacity: 0;}'
        +'  34% {bottom: 15px;opacity: 1;}'
        +'  56% {bottom: 15px;opacity: 1;}'
        +'  60% {bottom: 15px;opacity: 0;}'
        ...
        +'  30% {top: 15px;opacity: 0;}'
        +'  35% {top: 15px;opacity: 1;}'
        ...
        +'  right: -20px;'
        +'  opacity: 0;'
        +'  mask: url(' + my.seq02DisrRight2BG + ') no-repeat center center;'
        +'  -webkit-mask: url(' + my.seq02DisrRight2BG + ') no-repeat center center;'
        ...
        +'  65% {bottom: 45px;opacity: 1;}'
        +'  68% {bottom: 45px;opacity: 1;}'
        +'  69% {bottom: 43px;opacity: 1;}'
        +'  70% {bottom: 45px;opacity: 1;}'
        ...
        +'  left: 183px;'
        +'  width: 83px;'
        +'  animation-name: pricefootnoteani;'
        +'  animation-duration: 15s;'
        +'  animation-timing-function: ease-in-out();'
        +'  animation-fill-mode: forwards;'
        +'  animation-iteration-count: 2;'
