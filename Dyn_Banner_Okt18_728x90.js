...
var NFQDA = (function(my) {
    ...
    my.createCss = function(doc) {
        ...
        +'  62% {top: 32px;opacity: 0}'
        +'  68% {top: 32px;opacity: 1}'
        +'  69% {top: 35px;opacity: 1}'
        +'  70% {top: 32px;opacity: 1}'
        +'  73% {top: 32px;opacity: 1}'
        +'  74% {top: 35px;opacity: 1}'
        +'  75% {top: 32px;opacity: 1}'
        ...
        +'  99.8% {bottom: 11px;left:700px;opacity: 1;}'
