...
var NFQDA = (function(my) {
    ...
    my.createCss = function(doc) {
        ...
        +'  5% {opacity: 1; top:6px;}'
        +'  25% {opacity: 1; top:6px;}'
        +'  30% {opacity: 0; top:6px;}'
        ...
        +'  5% {top: 24px;opacity: 1;}'
        +'  25%{top: 24px;opacity: 1;}'
        +'  30%{top: 24px;opacity: 0;}'
        ...
        +'  62% {top: 33px;opacity: 0}'
        +'  68% {top: 33px;opacity: 1}'
        +'  69% {top: 36px;opacity: 1}'
        +'  70% {top: 33px;opacity: 1}'
        +'  73% {top: 33px;opacity: 1}'
        +'  74% {top: 36px;opacity: 1}'
        +'  75% {top: 33px;opacity: 1}'
        ...
        +'@keyframes fingerani {'
        +'  0% {bottom: 0px;left:750px;opacity: 0;}'
        +'  62% {bottom: 0px;left:750px;opacity: 0;}'
        +'  68% {bottom: 30px;left:700px;opacity: 1;}'
        +'  69% {bottom: 27px;left:700px;opacity: 1;}'
        +'  70% {bottom: 30px;left:700px;opacity: 1;}'
        +'  73% {bottom: 30px;left:700px;opacity: 1;}'
        +'  74% {bottom: 27px;left:700px;opacity: 1;}'
        +'  75% {bottom: 30px;left:700px;opacity: 1;}'
        +'  99.8% {bottom: 30px;left:700px;opacity: 1;}'
        +'  100% {bottom: 30px;left:700px;opacity: 0;}'
        +'}'
